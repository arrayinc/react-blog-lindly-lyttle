...
const BlogPageInfo = [
    ...
    },
    {
        ...
        image: MorningCoffee,
        photocredit: "Mukul Wadhwa | @mukulwadhwa",
        quote: "Rise and shine. I’ve always held such fondness for that sweet old phrase. As though we are all little Suns. As though we are all someone’s day. ―Beau Taplin",
        introtext: "What’s the Rush? There's infinite untapped power in a slow morning.",
        contentblockone: "As an antidote to our tech-obsessed society, slow-morning practitioners wake up early to meditate, read, exercise or do nothing at all. In reaction to hectic, over-scheduled lives burdened by 24-7 technology, a counter movement is emerging: the slow morning. Proponents spend time—sometimes hours—doing very little in the morning. Rising early, they relish beginning their day in quiet solitude, free of interruptions and deadlines. They say it provides a foundation for productivity, calm and focus that lasts the rest of the day.",
    ...
    },
    {
        ...
        image: WFH,
        photocredit: "Mukul Wadhwa | @mukulwadhwa",
        quote: "It's very important that we re-learn the art of resting and relaxing. Not only does it help prevent the onset of many illnesses that develop through chronic tension and worrying; it allows us to clear our minds, focus, and find creative solutions to problems. - Thich Nhat Hanh",
        introtext: "Whether you’re a morning person or a night owl, we all start our day at some point.",
        contentblockone: "And we all seem to start it differently. Some of us hop online to check social media, others dive in to email, still others eat breakfast, exercise, or pack lunches for the kids. There’re a million different ways a morning could go. Which morning routine might be best? While there’s probably not an ideal morning routine that fits everyone, we can learn a lot from the morning routines of successful people as well as from the research and inspiration behind starting a morning on the right foot. I collected a wide range of opinions on how best to start a day, from the scientific to the successful. Here’s the best of what I found—maybe it’ll help you get a little more productivity, creativity, and enjoyment out of your morning.",
        headerblocktwo: "SCIENCE SAYS: WILLPOWER IS HIGHEST IN THE MORNING, SO START STRONG.",
        contentblocktwo: "You’ve maybe heard the advice that your first work of the day should be something meaningful and significant, a task that might take a lot of focus, will, and determination to accomplish. The reason: We’re limited with our self-control. That’s the idea purported by the strength model. Self-control draws from a common resource that gets depleted over time. You can think of self-control as a muscle–fatigue sets in after exertion. Researchers at the University of Nottingham and the National Institute of Education in Singapore reviewed 83 studies on self-control to come to the following conclusion: Results revealed a significant effect of ego depletion on self-control task performance. Significant effect sizes were found for ego depletion on effort, perceived difficulty, negative affect, subjective fatigue, and blood glucose levels. For those scoring at home, that’s both a psychological and physiological effect on your ability to get work done. The longer the day goes on, the more fatigue your self-control experiences, the more important it is to make those early morning hours count.",
    ...
    },
    {
        ...
        image: Holistic,
        photocredit: "Mukul Wadhwa | @mukulwadhwa",
        quote: "Affirmation: I release the control to the universe. I am at peace with myself.",
    ...
    },
    {
        ...
        headerblocktwo: "One example of a mindfulness exercise is called the Five Senses Exercise.",
        contentblocktwo: "The goal is to calm your mind by using your five senses to focus on your environment instead of your thoughts.",
        headerblockthree: "First, notice 5 things that you can see.",
    ...
    },
    {
        ...
        title: "Art Therapy",
        subtitle: "Your brain on art and 8 excercises for you to express and create.",
        author: "Abby Lyttle",
        authoravatar: AbbyPhoto,
        date: "20 March 2021 | 6 min read ",
        image: ArtTherapy,
        introtext: "When we engage in the creation of our own art forms, we receive big benefits to our minds, both physically and mentally.",
        contentblockone: "When we produce art with our own hands, there is increased neural connectivity in the area of the brain that deals with introspection, memory, and self-monitoring. This means that this area is more active when engaged in producing art. Mentally, we become more psychologically resilient, we have increased positive perspectives, and become more self-aware. This helps us to cope with future problems, stressors, or events. It is said that the pairing of actually creating the art (motor processing) and thinking about expression (cognitive processing) is what makes art therapy so beneficial.",
        headerblocktwo: "Emotions",
        contentblocktwo: "Paint or draw your emotions. Here, you want to think about how you are feeling and put that feeling into paper, however you see it.",
        headerblockthree: "Create an emotion wheel",
        contentblockthree: "You’ll want to use lots of color for this activity! Label each emotion with a color that fits for you.",
        headerblockfour: "Design a postcard that you will never send",
        contentblockfour: "This activity helps with releasing anger in a way that never has to be presented to someone else.",
        headerblockfive: "Coloring books for emotions",
        contentblockfive: "You can buy, or print, certain coloring pages that were created to release emotions.",
        headerblocksix: "Happiness",
        contentblocksix: "Make a collage related to a quote that speaks to you. Turn words that mean a lot to you and turn it into a visual that is inspiring.",
        headerblockseven: "Draw a wild invention",
        contentblockseven: "This activity will get your creative juices flowing and will most likely be wild and funny!",
        headerblockeight: "Draw animals you love",
        contentblockeight: "For some people, animals are a source of love and happiness. Draw the ones that you love the most (your own pet included).",
        headerblocknine: "Draw, color, or paint your idea of the perfect day or perfect home",
        contentblocknine: "This activity will help you create a visual of spaces and things that feel safe and warm to you.",
    },
    {
